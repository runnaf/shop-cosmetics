    ...
    <section className="about section">
      ...
      <div className="about__container">
        <div>
          ...
          <img className="about__image-one" src={ shop } width='461' height="632" alt="наш магазин" />
        </div>    
        <div className="about__wrapper" >
          <img className="about__image-two"  src={ natural } width='705' height="736" alt="наш магазин" />
